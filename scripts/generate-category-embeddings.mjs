...
for (const category of DEFAULT_CATEGORIES) {
  ...
  categories.push({
    ...
    promptEmbeddings: promptEmbeddings.map((values) =>
      Array.from(values, (value) => Number(value.toFixed(8))),
    ),
...
const payload = {
  ...
  scoring: "maximum positive prompt similarity across full image and 2x2 crops",
